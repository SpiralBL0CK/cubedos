...
edit them to suit your needs. They are heavily commented to help guide you. The expectation
is that you will ultimately remove most, if not all, of the comments there and replacement
them with application-specific comments as appropriate.
...
messages to other modules, and ultimately sending a reply message back to the requester.
